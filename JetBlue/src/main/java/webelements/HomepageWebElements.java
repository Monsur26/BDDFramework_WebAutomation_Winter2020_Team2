...
public class HomepageWebElements {
    public static final String bookWebElement="Book";
    public static final String bookFlightWebElement="Flights";
    public static final String bookFlightTextWebElement="body > jb-app > jb-flights > div > jb-flight-deals > div > h1";
    public static final String exploreWebElement="Explore";
    public static final String newYorkWebElement="New York";
    public static final String newYorkTextWebElement="body > jb-app > jb-flights-destination > div > jb-flight-deals > div > h1";
    public static final String losAngelesWebElement="Los Angeles";
    public static final String NYtoLAWebElement="#seoDeal4 > div";
    public static final String NYtoLATextWebElement="#first-focus";
    public static final String signInWebElement="Sign in";
    public static final String emailWebElement="input[type='email']";
    public static final String passwordWebElement="input[type='password']";
    public static final String submitWebElement="button[type='submit']";
    public static final String signInTextWebElement="/html/body/jb-app/jb-basic-template/div/div/jb-sign-in-page/div/div[2]/div/jb-trueblue/div/h1";
    public static final String travelAlertWebElement="Travel Alerts";
    public static final String airportAlertWebElement="//a[contains(text(),'Airport alerts')]";
    public static final String airportAlertTextWebElement="//span[contains(text(),'Airport alerts')]";
