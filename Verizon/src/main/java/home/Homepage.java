...
public class Homepage extends WebAPI {
    ...
    public void validateHoverShops(){
        ...
        Assert.assertEquals("not successful","Shop",actual);
    }
    ...
    public void validateScrollingDown(){
        ...
        Assert.assertEquals("not successful","© Verizon 2020",actual);
    }
    ...
    public void validateGenerateSignIN(){
        ...
        Assert.assertEquals("not successful","User ID & Password",actual);
    }
