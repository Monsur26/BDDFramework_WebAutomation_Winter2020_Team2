...
public class StepDefinitionUF extends WebAPI {
     //System.setProperty("webdriver.chrome.driver","BrowserDriver/mac/chromedriver3");
    //WebDriver driver=new ChromeDriver();
    @Before
    public void openBrowser() throws IOException {
        setUp(false, "browserstack", "OS X", "High Sierra", "chrome", "83", "https://www.uhc.com/");
        //setup("https://www.uhc.com/");
    }
